class scraper
  ...
  attr_accessor :title, :hotness, :image_url, :rating, :director, :release_date, :runtime, :synopsis, :failure

  def scrape_new_movie
    begin
      doc = Nokogiri::HTML(open("http://www.rottomtomatoes.com/m/the_martian/"))
      ...
      self.failure = "Something went wrong with things"
    end
  end
end
